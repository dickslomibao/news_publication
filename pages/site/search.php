...
$list = $newslist->getAllPublishedNews();

$searchResult = [];
foreach ($list as $item) {
  
    if (strpos(strtolower($item['newstitle']), strtolower($_GET['search'])) or strpos(strtolower($item['category']), strtolower($_GET['search']))) {
        ...
        <div class="container-fluid">
            <div class="row">
                <h4 class="latest-header-title" style="margin: 40px 0;">
                    Search Result: <?php echo count($searchResult);?>
                </h4>
