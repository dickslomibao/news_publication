...
$writerList = $writers->getAllPersonalAndAcountInfo();
...
<body>
    ...
    <div class="margin-side">
        <table class="table table-striped" id="myTable" border="1">
            ...
            <tbody>
                <?php foreach ($writerList as $item) { ?>
                    <tr valign="middle">
                        ...
                        <td>
                            <center>
                                <a href="viewwritersinfo.php?id=<?php echo $item['id'] ?>" class="btn btn-success">View</a>
                                <?php if ($item['role'] === '5') { ?>
                                    <a href="restricter.php?restrict=false&id=<?php echo $item['id'] ?>" class="btn btn-danger">Unrestrict</a>
                                <?php } else { ?>
                                    <a href="restricter.php?restrict=true&id=<?php echo $item['id'] ?>" class="btn btn-danger">Restrict</a>
                                <?php } ?>
                            </center>
                        </td>
                    </tr>
