        ...
        <div class="container-fluid">
            <div class="row">
                <div class="title-row">
                    ...
                    <a href="../site/changepass.php" class="change-pass-btn">
                        Change password
                    </a>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $personalInfo[0]['middlename']; ?>" type="texr" class="form-control" id="" name="mname" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $personalInfo[0]['mobilenumber']; ?>" type="number" class="form-control" id="" name="mnumber" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                        <label for="">Address:</label>
                                        <input value="<?php echo $personalInfo[0]['address']; ?>" type="text" class="form-control" id="" name="address" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $personalInfo[0]['birthdate']; ?>" type="date" class="form-control" id="" name="bdate" required>
                                    </div>
                                    <div class="form-group">
